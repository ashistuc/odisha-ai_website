...
import SkillingOnAI from '../components/SkillingOnAI';
...
const Home = () => {
  ...
  const [showIntroQuotes, setShowIntroQuotes] = useState(true);
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Featured AI Projects in <span className="bg-gradient-to-r from-blue-600 to-orange-600 bg-clip-text text-transparent">Odisha</span>
            </h2>
      ...
      {/* Skilling on AI Section */}
      <section id="skilling-section" className="py-20 bg-white dark:bg-gray-900 section-transition relative overflow-hidden">
        {/* Transparent training background */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative ">
          <SkillingOnAI programs={aiTrainingPrograms} />
        </div>
      </section>
      ...
      <section id="news-section" className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              AI News & <span className="bg-gradient-to-r from-blue-600 to-orange-600 bg-clip-text text-transparent">Updates</span>
            </h2>
      ...
      <section id="tools-section" className="py-20 bg-orange-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              AI Tools & <span className="bg-gradient-to-r from-blue-600 to-orange-600 bg-clip-text text-transparent">Resources</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
      ...
      <section id="links-section" className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Important <span className="bg-gradient-to-r from-blue-600 to-orange-600 bg-clip-text text-transparent">Links</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
